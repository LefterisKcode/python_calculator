...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ""
        Entry(width=17, bg="#f0ecb1", font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)
        
        Button(width=11, height=4, text="(", relief="flat", bg="white", command=lambda: self.show('(')).place(x=0, y=50)
        Button(width=11, height=4, text=")", relief="flat", bg="white", command=lambda: self.show(')')).place(x=90, y=50)
        Button(width=11, height=4, text="%", relief="flat", bg="white", command=lambda: self.show('%')).place(x=180, y=50)
        Button(width=11, height=4, text="7", relief="flat", bg="#e8e8e8", command=lambda: self.show(7)).place(x=0, y=125)
        Button(width=11, height=4, text="8", relief="flat", bg="#e8e8e8", command=lambda: self.show(8)).place(x=90, y=125)
        Button(width=11, height=4, text="9", relief="flat", bg="#e8e8e8", command=lambda: self.show(9)).place(x=180, y=125)
        ...
        Button(width=11, height=4, text="1", relief="flat", bg="#e8e8e8", command=lambda: self.show(1)).place(x=0, y=275)
        Button(width=11, height=4, text="3", relief="flat", bg="#e8e8e8", command=lambda: self.show(3)).place(x=180, y=275)
        Button(width=11, height=4, text="2", relief="flat", bg="#e8e8e8", command=lambda: self.show(2)).place(x=90, y=275)
